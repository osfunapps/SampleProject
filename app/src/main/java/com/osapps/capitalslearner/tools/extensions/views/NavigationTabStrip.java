package com.osapps.capitalslearner.tools.extensions.views;/*
...
public class NavigationTabStrip extends View implements ViewPager.OnPageChangeListener {
    ...
    // Detect if we getString action down event
    private boolean mIsActionDown;
    // Detect if we getString action down event on strip
        ...
        if (mAnimatorListener == null)
            mAnimatorListener = new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(final Animator animation) {
                    ...
                    if (mOnTabStripSelectedIndexListener != null)
                        mOnTabStripSelectedIndexListener.onEndTabSelected(mTitles[mIndex], mTypes[mIndex], mIndex);
                }
            };

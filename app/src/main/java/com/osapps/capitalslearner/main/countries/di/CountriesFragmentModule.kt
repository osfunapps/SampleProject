package com.osapps.capitalslearner.main.countries.di
...
import com.osapps.capitalslearner.main.countries.presentation.CountriesFragPresenterImpl
import com.osapps.capitalslearner.main.countries.presentation.list.CountriesAdapter
import com.osapps.capitalslearner.main.countries.presentation.narrator.CountriesNarrator
...
import com.osapps.capitalslearner.main.countries.view.CountriesFragView
import com.osapps.capitalslearner.main.countries.view.dialogs.AddCountryDialog
import com.osapps.capitalslearner.main.countries.view.dialogs.CardDialog
import com.osapps.capitalslearner.main.countries.view.dialogs.RemoveCountryDialog
...
class CountriesFragmentModule {
    ...
    @Provides
    internal fun provideCountriesFragmentView(countriesFragment: CountriesFragment): CountriesFragView = countriesFragment
    ...
    //add country dialog
    @Provides
    internal fun provideAddCountryDialog(countriesFragment: CountriesFragment): AddCountryDialog {
        return AddCountryDialog(countriesFragment.activity, countriesFragment)
    }

    //remove country dialog
    @Provides
    internal fun provideRemoveCountryDialog(countriesFragment: CountriesFragment): RemoveCountryDialog {
        return RemoveCountryDialog(countriesFragment.activity, countriesFragment)
    }

    //card dialog
    @Provides
    internal fun provideCardDialog(countriesFragment: CountriesFragment): CardDialog {
